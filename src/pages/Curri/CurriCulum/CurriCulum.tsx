...
import { closestCorners, DndContext, DragOverlay, PointerSensor, useSensor, useSensors, type DragEndEvent, type DragStartEvent } from "@dnd-kit/core";
    ...
    return (
        ...
        >
            <div className="relative min-h-screen bg-slate-50 overflow-hidden ">
                ...
                <main className="relative z-10 flex h-[calc(100vh-73px)] p-0 gap-6">
                    ...
                    <div className="flex-1 h-full flex flex-col gap-6 overflow-y-auto pr-2 custom-scrollbar">
                        {/* 상단 타이틀 안내 */}
                        ...
                        <div className="flex-1 bg-white rounded-[2.5rem] border border-slate-200 shadow-xl shadow-slate-200/50 flex items-center justify-center p-10 text-slate-300">
                            <div className="text-center">
                                <Layout size={48} className="mx-auto mb-4 opacity-20" />
                                <p className="font-bold">과목을 배치하면 실시간 편성표가 이곳에 생성됩니다.</p>
                            </div>
                        </div>
                    </div>
                </main>
