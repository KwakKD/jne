...
import { AJU, DANGUK, DONGAH, DUKSUNG, GATHOLIC, GORYU, GUKMIN, GUNGUK, GWANGWON, GYOUNGGI, GYOUNGHWE, GYOUNGSUNG, HANCHE, HANGUKHANGGONG, HANYANG, HANYANGERICA, HYUPSUNG, INHA, JOONGANG, SEOUL, SEOULGWAGI, SEOULSILIP, SOONGSIL, SUNGGYUL } from "./universe";
