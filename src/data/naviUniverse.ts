...
import { AJU, BUSAN, CHOUNGNAM, CHUNGBUK, DANGUK, DANGUK_CHUNAN, DONGAH, DONGGUK, DUKSUNG, GANGWON1, GANGWON2, GATHOLIC, GORYU, GUKMIN, GUNGUK, GUNGUK_GLO, GWANGJUEDU, GWANGWON, GYOUNGBUK, GYOUNGGI, GYOUNGHWE, GYOUNGSUNG, HANBAT, HANCHE, HANGUKGISUL, HANGUKHANGGONG, HANLA, HANYANG, HANYANGERICA, INHA, JEONBUK, JEONJU, JEONNAM, JEONNAM_1, JINJUEDE, JOONGANG, JOSUN, POSTECH, SEOUL, SEOULGWAGI, SEOULSILIP, SOONGSIL, WONGWANG, YOUNSAE } from "./universe";
