...
import { AJU, BUSAN, CHOUNGNAM, DAEJEONGATHOLIC, DANGUK, DONGAH, DUKSUNG, GATHOLIC, GORYU, GUKMIN, GUNGUK, GWANGWON, GYOUNGBUK, GYOUNGGI, GYOUNGHWE, GYOUNGSUNG, HANBAT, HANCHE, HANGUKHANGGONG, HANYANG, HANYANGERICA, HYUPSUNG, INHA, JINJUEDE, JOONGANG, POSTECH, SEOUL, SEOULGWAGI, SEOULSILIP, SOONGSIL, SUNGGYUL } from "./universe";
...
const NAV_UNIVERSE_DATA: UniverseType[] = [
    ...
    ...DUKSUNG, ...SEOULGWAGI, ...SEOUL, ...SEOULSILIP, ...SOONGSIL, ...JOONGANG, ...HANCHE, ...HANYANG,
    ...INHA,
    ...GYOUNGGI, ...DANGUK, ...SUNGGYUL, ...AJU, ...HANGUKHANGGONG, ...HANYANGERICA, ...HYUPSUNG,
    ...GYOUNGSUNG, ...DONGAH, ...BUSAN,
    ...GYOUNGBUK,
    ...POSTECH,
    ...JINJUEDE,
    ...HANBAT, ...DAEJEONGATHOLIC,...CHOUNGNAM
]
